...
<body>
    ...
    <?php
        ...
        try{
            ...
            $plat = "SELECT nom, id, prix FROM carte WHERE catégorie= 'plat'";
            ...
            if ($st->rowCount() > 0) {
                while ($row = $st->fetch(PDO::FETCH_ASSOC)) {
                    echo $row['nom'] . " : " . $row['prix'] . "€" . " - ID : " . $row['id'] . "<br>";
                }
            } else {
                echo "0 résultats";
            }
            ...
            $boisson = "SELECT nom, id, prix FROM carte WHERE catégorie= 'boisson'";
            ...
            $dessert = "SELECT nom, id, prix FROM carte WHERE catégorie= 'dessert'";
    ...
    <?php
        ...
        try {
            ...
            if(!empty($_POST['idModif'])) {
                ...
                $sql = "UPDATE carte SET catégorie='$cat', nom='$nom', prix='$prix'  WHERE id='$id' ";
